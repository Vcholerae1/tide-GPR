...
receiver_locations[:, :, 0] = src_y
receiver_locations[:, :, 1] = receiver_x_positions  # 广播，同一条线
...
output_dir = Path("outputs") / (
    f"multi_wave_multi_{int(base_forward_freq / 1e6)}MHz_shots{n_shots}_bs{batch_size}_nt{nt}"
)
